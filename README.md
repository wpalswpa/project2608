...
**상관 0.7 이상인 쌍이 8개**인데, 그중 **4개가 골드가 낀 쌍**입니다(킬↔골드 0.918, 골드↔경험치 0.896, 골드↔레벨 0.834, 골드↔어시스트 0.758).
VIF도 **골드가 23.4로 1위**입니다(10 이상이면 중복).
...
**전체 점수**는 시험 데이터에서 0.7036 → **0.7561**, AUC 0.7729 → **0.8344**입니다.
그런데 이 평균값만 보면 중요한 걸 놓칩니다. 10분 상황별로 쪼개보면 이렇습니다.
