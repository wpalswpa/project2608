...
if __name__ == "__main__":
    ...
    a = experiment_a()
    b = experiment_b()
    a.round(4).to_csv("reports/tables/repeat_experimentA.csv", encoding="utf-8-sig")
    b.round(4).to_csv("reports/tables/repeat_experimentB.csv", encoding="utf-8-sig")
    print("\n[저장] reports/tables/repeat_experimentA.csv · repeat_experimentB.csv")
